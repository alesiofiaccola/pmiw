...
'caminando ve a unos niños jugando a\n un juego extraño', 'se retiene en su casa escribiendo poesías e historias para presentarlas en el pueblo', 'no está teniendo éxito presentando lo que escribe, ahora debe decidir','les pregunta enojado a que están jugando ¿que están haciendo?',
...
function draw() {
  ...
  if(diapositiva === "inicio"){
   ...
   if(diapositiva === "c1"){
    image(screens[8], 0, 0);
    fill(255);
    text(phrases[8], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "c2"){
    image(screens[9], 0, 0);
    fill(255);
    text(phrases[9], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "d1"){
    image(screens[10], 0, 0);
    fill(255);
    text(phrases[10], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "d2"){
    image(screens[11], 0, 0);
    fill(255);
    text(phrases[11], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "d3"){
    image(screens[12], 0, 0);
    fill(255);
    text(phrases[12], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "d4"){
    image(screens[13], 0, 0);
    fill(255);
    text(phrases[13], 100, 100);
   ...
   if(diapositiva === "e1"){
    ...
    fill(255);
    text(phrases[14], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "e2"){
    image(screens[15], 0, 0);
    fill(255);
    text(phrases[15], 100, 100);
    botton(100, 400, 110, 50, "Fin");
  }
   if(diapositiva === "f1"){
    image(screens[16], 0, 0);
    fill(255);
    text(phrases[16], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "f2"){
    image(screens[17], 0, 0);
    fill(255);
    text(phrases[17], 100, 100);
    botton(100, 400, 110, 50, "Fin");
  }
   if(diapositiva === "g1"){
    image(screens[18], 0, 0);
    fill(255);
    text(phrases[18], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "g2"){
    image(screens[19], 0, 0);
    fill(255);
    text(phrases[19], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "g3"){
    image(screens[20], 0, 0);
    fill(255);
    text(phrases[20], 100, 100);
    botton(100, 400, 110, 50, "Fin");
  }
   if(diapositiva === "h1"){
    image(screens[21], 0, 0);
    fill(255);
    text(phrases[21], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "h2"){
    image(screens[22], 0, 0);
    fill(255);
    text(phrases[22], 100, 100);
    botton(100, 400, 110, 50, "siguiente");
  }
   if(diapositiva === "h3"){
